...
(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  instance.interceptors.response.use(function (response) {
      var res = responseInterceptor(response);
      if (res.status === 200) {
          return res.data;
      }
      else {
          var err = errorInterceptor(res);
          return Promise.reject(err);
      }
  }, errorInterceptor);
  var get = function (url, data, options) {
      if (options === void 0) { options = {}; }
      return instance.get(url, __assign(__assign({}, options), { method: 'GET', params: data }));
  };
  var post = function (url, data, options) {
      if (options === void 0) { options = {}; }
      return instance.post(url, data, __assign(__assign({}, options), { method: 'POST' }));
  };
  var request = {
      get: get,
      post: post
